package com.tomlockapps.userbrowser.data.source.remote.github.model;
...
public class GithubUserModel implements IUserModel {
    ...
    public static final Creator<GithubUserModel> CREATOR = new Creator<GithubUserModel>() {
        @Override
